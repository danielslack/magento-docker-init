...
class Mage_Customer_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function getFullCustomerName($object = null)
    {
        ...
        if (is_null($object)) {
            ...
            if (
                $config->getAttribute('customer', 'suffix')->getIsVisible()
                && ($object->getSuffix()
    ...
    public function getLoginUrlParams()
    {
        ...
        if (
            !$referer && !Mage::getStoreConfigFlag(self::XML_PATH_CUSTOMER_STARTUP_REDIRECT_TO_DASHBOARD)
